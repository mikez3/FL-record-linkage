...
## Scikit-learn
This application uses [cuML](https://docs.rapids.ai/api/cuml/stable/). [Scikit-learn](https://scikit-learn.org/) can also be used as backend instead of Scikit-learn.
